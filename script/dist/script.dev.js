...
function ControlWidth() {
  var sirka = window.innerWidth; //Deklarace proměný, kde se ukládá šířka okna
...
window.addEventListener('resize', ControlWidth); //Díky tomuto může fungovat animace, když se přidává nebo odebírá přidaná třída do elementu.